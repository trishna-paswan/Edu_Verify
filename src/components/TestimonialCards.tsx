...
function EduVerifyHighlights() {
  return (
    <div className="h-screen w-full bg-black bg-grid-white/[0.2] relative flex flex-col items-center justify-center overflow-hidden">
      <div
        className={cn(
          'absolute inset-0',
      ...
      <h2 className="text-3xl font-bold text-center mb-8 z-10 text-neutral-50 m-6">
        Why EduVerify?
      </h2>
      <div className="flex justify-center w-full overflow-hidden px-4 sm:px-6 lg:px-8 py-8">
        <div className="relative w-full max-w-6xl overflow-hidden">
          <InfiniteMovingCards items={eduVerifyHighlights} direction="right" speed="slow" />
